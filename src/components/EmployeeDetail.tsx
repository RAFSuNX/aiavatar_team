  ...
  if (!employee) {
    return (
      <div className="min-h-screen gradient-bg text-[rgb(var(--color-text))] p-4 sm:p-6 md:p-8 flex items-center justify-center">
        <div className="text-center border-2 border-[rgb(var(--color-border))] p-8 max-w-md w-full">
  ...
  return (
    <div className="min-h-screen gradient-bg text-[rgb(var(--color-text))] p-4 sm:p-6 md:p-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="border-2 border-[rgb(var(--color-border))]">
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-3">
                  {employee.responsibilities.map((responsibility, index) => (
                    <div 
                      key={index}
                      className="border-2 border-[rgb(var(--color-border))] p-4 transition-all duration-300 hover:translate-x-2"
                    >
                      {responsibility}
                    </div>
                  ))}
